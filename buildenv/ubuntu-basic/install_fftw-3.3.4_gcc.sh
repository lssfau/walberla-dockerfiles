...
patch -b -p1 <<EOF  2>&1 | tee $LOGFILE
diff -rupN fftw-3.3.4/mpi/conf.c fftw-3.3.4-patched/mpi/conf.c
--- fftw-3.3.4/mpi/conf.c	2014-03-04 19:41:03.000000000 +0100
+++ fftw-3.3.4-patched/mpi/conf.c	2015-09-05 05:53:19.085516467 +0200
...
diff -rupN fftw-3.3.4/mpi/Makefile.am fftw-3.3.4-patched/mpi/Makefile.am
--- fftw-3.3.4/mpi/Makefile.am	2013-03-18 13:10:45.000000000 +0100
+++ fftw-3.3.4-patched/mpi/Makefile.am	2015-09-05 05:53:19.084516437 +0200
...
diff -rupN fftw-3.3.4/mpi/mpi-transpose.h fftw-3.3.4-patched/mpi/mpi-transpose.h
--- fftw-3.3.4/mpi/mpi-transpose.h	2014-03-04 19:41:03.000000000 +0100
+++ fftw-3.3.4-patched/mpi/mpi-transpose.h	2015-09-05 05:53:19.085516467 +0200
...
diff -rupN fftw-3.3.4/mpi/transpose-alltoall-transposed.c fftw-3.3.4-patched/mpi/transpose-alltoall-transposed.c
--- fftw-3.3.4/mpi/transpose-alltoall-transposed.c	1970-01-01 01:00:00.000000000 +0100
+++ fftw-3.3.4-patched/mpi/transpose-alltoall-transposed.c	2015-09-05 05:53:19.085516467 +0200
@@ -0,0 +1,280 @@
+/*
...
+}
diff -rupN fftw-3.3.4/mpi/transpose-pairwise.c fftw-3.3.4-patched/mpi/transpose-pairwise.c
--- fftw-3.3.4/mpi/transpose-pairwise.c	2014-03-04 19:41:03.000000000 +0100
+++ fftw-3.3.4-patched/mpi/transpose-pairwise.c	2015-09-05 06:00:05.715433709 +0200
...
diff -rupN fftw-3.3.4/mpi/transpose-pairwise-transposed.c fftw-3.3.4-patched/mpi/transpose-pairwise-transposed.c
--- fftw-3.3.4/mpi/transpose-pairwise-transposed.c	1970-01-01 01:00:00.000000000 +0100
+++ fftw-3.3.4-patched/mpi/transpose-pairwise-transposed.c	2015-09-05 06:00:07.280481042 +0200
@@ -0,0 +1,510 @@
+/*
+ * Copyright (c) 2003, 2007-11 Matteo Frigo
+ * Copyright (c) 2003, 2007-11 Massachusetts Institute of Technology
...
autoreconf --verbose --symlink --force 2>&1 | tee -a $LOGFILE
